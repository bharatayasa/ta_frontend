...
const UserProfile = () => {
    ...
    return (
        <div>
            <div>
                <button onClick={handleShow} className="text-lg text-white bg-sky-400 px-3 py-3 rounded-lg hover:shadow-xl hover:bg-sky-500 transition duration-300 ease-in-out shadow-md lg:mr-2 md:mr-2 sm:mr-2 sm:mb-2 lg:mb-0">
                    <div className='flex'>
                        <div>
                            Profile 
                        </div>
