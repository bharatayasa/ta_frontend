            ...
            {show && (
                <div className="fixed inset-0 mt-20" onClick={handleClose}>
                    ...
                    <div className="text-center pb-10">
                        <div ref={modalRef} className="inline-block rounded-lg text-left overflow-auto shadow-xl transform sm:my-8 sm:align-middle sm:max-w-lg sm:w-full bg-white/40 backdrop-blur-sm !important">
