                ...
                <section>
                    <div className='container mx-auto'>
                        <div className='flex flex-wrap justify-center items-center'>
                            ...
                            <div className='self-end lg:px-4 sm:px-20 lg:w-1/2 sm:w-full md:w-full backdrop-blur-2xl bg-white/30 rounded-xl shadow-sm'>
                                <div className='mt-10'>
                                    <form onSubmit={this.onSubmitHandler}>
                                        ...
                                        <div className='mr-3 ml-3 mb-3'>
                                            ...
                                            <input type="text" placeholder="Username" autoComplete="off" value={this.state.username} onChange={this.onUsernameChangeHandler} className="w-full border-2 rounded-md py-2 px-3 focus:outline-none focus:border-blue-400" />
                                        </div>
                                        ...
                                        <div className='mr-3 ml-3 mb-5 relative'>
                                            ...
                                            <input type={showPassword ? "text" : "password"} placeholder="Password" value={this.state.password} onChange={this.onPasswordChangeHandler} className="w-full border-2 rounded-md py-2 px-3 focus:outline-none focus:border-blue-400" />
