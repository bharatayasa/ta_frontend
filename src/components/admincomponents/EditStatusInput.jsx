		...
		{show && (
			...
			<div className="text-center pb-10">
				...
				<div className="bg-white/40 backdrop-blur-sm pt-4 sm:px-6 sm:pb-4 px-10 py-6">
					...
					<div>
						<select name="status" value={predictsData.status} onChange={(e) => handleFieldChange('status', e.target.value)} className='bg-white/25 backdrop-blur-xl shadow-lg w-full rounded-lg py-2 px-3 border-1-emerald'>
