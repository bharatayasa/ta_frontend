...
function UpdateStatus({ id, onUpdateStatus }) {
    ...
    return (
        <div>
            <button className='text-l text-white bg-sky-600 px-3 py-2 rounded-md hover:shadow-xl hover:bg-sky-700 transition duration-300 ease-in-out shadow-md' onClick={handleUpdate}>
                <div className='flex'>
                    <div>
                        Hapus
                    </div>
